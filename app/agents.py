...
שלב 4: החזר תוצאות
- רשימה של 2-3 סיפורים עם קישורים
- **⚠️ CRITICAL: השתמש בקישורים המדויקים מכלי החיפוש - אל תשנה אותם!**
- **כל קישור כבר עבר אימות והוא מובטח לעבוד**
- **העתק את הקישור בדיוק כמו שהוא מופיע בתוצאות החיפוש**
- **המסר המרכזי (central_moral_theme) - חייב!**
- רשימה של 2-3 רעיונות למשחקים
- תיאור קצר למה כל תוכן רלוונטי למסר
...
- לכל פעילות יש מסר מרכזי אחד (central_moral_theme)
...
- **⚠️ CRITICAL: קישורים לסיפורים - השתמש בקישורים המדויקים מהמחקר!**
- **אל תשנה, אל תקצר, אל תבנה מחדש את הקישורים**
- **העתק את הקישור בדיוק כמו שהוא - כל קישור כבר עבר אימות**
- הערות הכנה למדריך
