...
2. זהה קבוצת גיל: "חטיבה" = middle (10-13), "תיכון" = teen (14-16)
3. זהה משך זמן: חפש ביטויים כמו "40 דקות", "שעה" (ברירת מחדל: 40)
4. זהה או הסק ערכים מרכזיים מהנושא
5. שאל על פרטים חסרים אם צריך
